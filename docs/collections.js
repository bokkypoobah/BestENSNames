const Collections = {
  ...
  computed: {
    ...
    pagedFilteredSortedItems() {
      // logInfo("Collections", "pagedFilteredSortedItems - results[0..1]: " + JSON.stringify(this.filteredSortedItems.slice(0, 2), null, 2));
  ...
  methods: {
    ...
    toggleTokenContractJunk(item) {
      logInfo("Collections", ".methods.toggleTokenContractJunk - item: " + JSON.stringify(item, null, 2));
      store.dispatch('data/toggleTokenContractJunk', item);
    },
    toggleTokenContractFavourite(item) {
      logInfo("Collections", ".methods.toggleTokenContractFavourite - item: " + JSON.stringify(item, null, 2));
    ...
    rowSelected(item) {
      logInfo("Collections", "methods.rowSelected BEGIN: " + JSON.stringify(item, null, 2));
